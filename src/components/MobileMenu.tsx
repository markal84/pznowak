      ...
      <nav id="mobile-menu" className=" pt-12 flex flex-col items-center space-y-12">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="text-2xl text-gray-800 dark:text-gray-100 hover:text-[#B8860B] dark:hover:text-[#BFA181] transition-colors py-4 px-8 w-full text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold/60 rounded-sm"
            onClick={(e) => {
